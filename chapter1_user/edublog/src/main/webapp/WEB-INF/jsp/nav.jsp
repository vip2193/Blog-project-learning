	...
	<div class="container">
		<div class="row header">
			<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4">
				<a href="#"> <img src="img/logo black@3x.png" alt="logo"
					style="width: 110px; margin-bottom: 5px">
				</a>
			</div>
			<div class="col-lg-4 col-md-4 hidden-sm hidden-xs">
				<a href="#" class="nav-item">首页</a> <a href="#" class="nav-item">代码库</a>
				<a href="#" class="nav-item">问答</a> <a href="#" class="nav-item">资源</a>
			</div>

			<div class="visible-sm visible-xs col-sm-5 col-xs-4">
				<div class="dropdown">
					<a href="#" class="nav-item" id="dropdownMenu1"
						data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">首页</a>
					<span class="caret"></span>
					<ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
						<li><a href="#" class="nav-item">代码库</a></li>
						<li><a href="#" class="nav-item">问答</a></li>
						<li><a href="#" class="nav-item">资源</a></li>
					</ul>
				</div>
			</div>
			...
			<div
				...
				<c:choose>
					...
					<c:otherwise>
						<span class="hidden-sm hidden-xs" ><a href="#">写文章</a></li></span>
						&nbsp; &nbsp;
						<div class="btn-group">
						<a href="#" type="button" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<img style="border-radius: 25px;border: none;" width="50px" height="50px"  alt="" src="${pageContext.request.contextPath}/${userInfo.avatar}">
						</a>

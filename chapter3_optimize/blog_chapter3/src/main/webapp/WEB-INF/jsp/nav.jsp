...
<div class="bg" style="position: fixed; z-index: 100000">
	<div class="container">
		<div class="row header">
			...
			<div class="visible-sm visible-xs col-sm-5 col-xs-4">
				<div class="dropdown">
					...
					<li><a href="${pageContext.request.contextPath}/index.do" class="nav-item">首页</a></li>
			...
			<div
				class="col-lg-2 col-md-3 col-sm-4 col-xs-4 col-lg-offset-1  ">
				<!-- 使用表达式判断用户是否登录 -->
				<c:choose>
					...
					<c:otherwise>
						...
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
						        ...
						        <li><a href="${pageContext.request.contextPath}/user/myBlog.do">我的博客</a></li>
						        <li><a href="${pageContext.request.contextPath}/user/favorite.do">我喜欢的</a></li>
						        <li><a href="${pageContext.request.contextPath}/index.do">账户管理</a></li>
...
<div class="bg" style="height: 71px"></div>


<!-- 登录弹出框 	-->
<div class="modal fade" style="z-index: 100001" id="loginDialog" tabindex="-1" role="dialog"
...
<!-- 注册弹出框 -->
<div class="modal fade" style="z-index: 100001"  id="registerDialog" tabindex="-1" role="dialog"
	aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form id="registerForm"  action="user/register.do"
					class="form-horizontal  form-vertical registerForm" method="post">
					<div class="form-group">
						<div class="col-sm-12">
